---
title: "Simulation"
subtitle: "Source Data Download and NWS Case Detection Simulation"
date: last-modified
format:
  html: 
    df-print: kable
...
## Download OSF Data  
Spatial GeoTIFF files (.tif) depicting NWS estimated potential abundance and spread are available on the [Open Science Framework](https://osf.io/uvqmw/).  Here we link the location and download the files to a demonstration directory (`/demo`).  
...
#### Example Potential Abundance Maps
...
```{r fig_width=15, fig.height=8, warning=FALSE, message=FALSE}
...
```{r fig_width=15, fig.height=8, warning=FALSE, message=FALSE}
#| label: fig-estcount
#| fig-cap: "Estimated detections by week. Counts represent the weekly sum of counts in all raster cells."
#| 
det_plt
...
Save a copy of simulated point locations.  This file will be needed to run the [Tessellation](https://geoepi.github.io/hominivorax-geostat/spatial_domain.html) step.  
...
#| label: fig-simpnt1
#| fig-cap: "Simulated NWS case detections."
#| 
...
#### Next Step
Once supporting data has been downloaded and NWS case detections have been simulated, proceed to the  [Tessellation](https://geoepi.github.io/hominivorax-geostat/spatial_domain.html) page of this site. 
:::
