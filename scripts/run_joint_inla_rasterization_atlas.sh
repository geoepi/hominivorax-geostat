...
#SBATCH --job-name=phase3-rasterization-20725437
...
PHASE2_OUTPUT=/project/disease_ecology/nws-geostat-output/joint_inla_fit/prediction_projection_20725437
STAGE2_ARTIFACT=/project/disease_ecology/nws-geostat-output/joint_model/joint_model_inputs.rds
OUTPUT_DIR=/project/disease_ecology/nws-geostat-output/joint_inla_fit/raster_surfaces_20725437
RUN_ID=20725437
...
Rscript --vanilla scripts/run_joint_inla_rasterization.R \
