load_joint_inla <- function(repo_root = getwd()) {
  files <- c("preprocessing_validation.R", "joint_inla_config.R", "joint_inla_spde.R", "joint_inla_effects.R", "joint_inla_spec.R", "joint_inla_stacks.R", "joint_inla_build.R", "joint_inla_extract.R")
